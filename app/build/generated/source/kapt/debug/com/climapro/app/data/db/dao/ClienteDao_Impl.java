...
public final class ClienteDao_Impl implements ClienteDao {
  ...
  public ClienteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCliente = new EntityInsertionAdapter<Cliente>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `clientes` (`id`,`nombre`,`telefono`,`direccion`,`email`,`notas`,`fechaCreacion`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(7, entity.getFechaCreacion());
      }
    };
    ...
    this.__updateAdapterOfCliente = new EntityDeletionOrUpdateAdapter<Cliente>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `clientes` SET `id` = ?,`nombre` = ?,`telefono` = ?,`direccion` = ?,`email` = ?,`notas` = ?,`fechaCreacion` = ? WHERE `id` = ?";
      }
      ...
      public List<Cliente> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Cliente(_tmpId,_tmpNombre,_tmpTelefono,_tmpDireccion,_tmpEmail,_tmpNotas,_tmpFechaCreacion);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getById(final long id, final Continuation<? super Cliente> $completion) {
      ...
      public Cliente call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpFechaCreacion;
            _tmpFechaCreacion = _cursor.getLong(_cursorIndexOfFechaCreacion);
            _result = new Cliente(_tmpId,_tmpNombre,_tmpTelefono,_tmpDireccion,_tmpEmail,_tmpNotas,_tmpFechaCreacion);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<List<Cliente>> buscar(final String query) {
    final String _sql = "SELECT * FROM clientes WHERE nombre LIKE '%' || ? || '%' OR telefono LIKE '%' || ? || '%' OR direccion LIKE '%' || ? || '%'";
